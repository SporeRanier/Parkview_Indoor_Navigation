...
public class ScrollingFragment extends Fragment implements MapView.MapEventListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (Dev.getOpenGLMajorVersion(getActivity()) < MapView.REQUIRED_OPENGL_LEVEL) {
            Toast.makeText(getActivity(), String.format("OpenGL %d.0 is not supported on this device.", MapView.REQUIRED_OPENGL_LEVEL), Toast.LENGTH_LONG).show();
        ...
        mapView = (MapView) view.findViewById(com.arubanetworks.meridian.R.id.mr_mapview);
