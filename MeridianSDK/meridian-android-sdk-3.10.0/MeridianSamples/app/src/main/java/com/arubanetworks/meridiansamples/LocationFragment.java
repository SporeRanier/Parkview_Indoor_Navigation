...
public class LocationFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Button locationRequestButton = (Button) rootView.findViewById(R.id.location_request_button);
        locationRequestButton.setOnClickListener(requestListener);
        ToggleButton toggle = (ToggleButton) rootView.findViewById(R.id.location_toggle);
    ...
    private void addLogMessage(String message) {
        View v = getView();
        if(v == null)return;
        TextView tv = (TextView) v.findViewById(R.id.location_log);
        final ScrollView sv = (ScrollView) v.findViewById(R.id.location_scroll_log);
